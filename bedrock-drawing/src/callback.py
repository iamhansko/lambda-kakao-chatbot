...
def lambda_handler(event, context):
    ...
    print(f"https://{TEXT_TO_IMAGE_S3_BUCKET_NAME}.s3.{AWS_REGION_NAME}.amazonaws.com/{image_name}")
    ...
    requests.post(callback_url, json={
        ...
        "template": {
            "outputs": [
                {
                    "simpleImage": {
                        "imageUrl": f"https://{TEXT_TO_IMAGE_S3_BUCKET_NAME}.s3.{AWS_REGION_NAME}.amazonaws.com/{image_name}",
                        "altText" : "text-to-image"
                    }
                }
            ]
        }
    ...
    return f"https://{TEXT_TO_IMAGE_S3_BUCKET_NAME}.s3.{AWS_REGION_NAME}.amazonaws.com/{image_name}",